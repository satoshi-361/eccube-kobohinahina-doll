...
class PluginManager extends AbstractPluginManager
{
    ...
    {
        $entityManager = $container->get('doctrine')->getManager();
        $Plugin = $entityManager->getRepository(Plugin::class)->findByCode('YamatoPayment4');
    ...
    {
        $PluginRepository = $this->entityManager->getRepository(Config::class);
        $Config = $PluginRepository->findOneBy([]);
